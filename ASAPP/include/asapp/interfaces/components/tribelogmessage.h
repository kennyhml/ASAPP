...
namespace asa::interfaces::components
{
    ...
    public:
        struct Event
        {
            enum EventType : int
            {
                ...
                ENEMY_DESTROYED,        // Structure of an enemy tribe was destroyed (orange)
    ...
    public:
        Timestamp timestamp;
        Event::EventType event = Event::UNKNOWN;
